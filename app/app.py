...
barcos = get_barcos()
barco = st.selectbox('Seleccione el baro', options=barcos, index=barcos.index(235009420))

dia = st.date_input('Seleccione el ía', min_value=date(2020, 1, 1), max_value=date(2020, 12, 31), value=date(2020, 6, 3))
